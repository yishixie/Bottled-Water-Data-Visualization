...
function configSigmaElements(config) {
    ...
    if (config.features.hoverBehavior == "dim") {
		...
		var greyColor = 'rgba(255,255,255,0.1)'; //dimming dim hover effect
		...
		if(nodes.indexOf(e.source)<0 && nodes.indexOf(e.target)<0){
			if(!e.attr['grey']){
				e.attr['true_color'] = 'rgba(255,255,255,0.3)';
				e.color = greyColor;
				e.attr['grey'] = 1;
			}
		}else{
			e.color = e.attr['grey'] ? e.attr['true_color'] : 'rgba(255,255,255,1.0)';
			e.attr['grey'] = 0;
    ...
    var a = [],
        ...
        for (b in sigInst.clusters) {
            console.log(b);
            var keyTitle;
            if (b == "rgb(163,255,161)"){
                keyTitle = "Branding";
            }else if(b == "rgba(41,197,210,0.8)"){
                keyTitle = "Country";
            }else if(b == "rgba(50,80,252,0.8)"){
                keyTitle = "Brand Name";
            }else if(b == "rgb(255,117,117)"){
                keyTitle = "pH >9";
            }else if(b == "rgb(255,163,117)"){
                keyTitle = "pH 7.0-7.9";
            }else if(b == "rgba(194,162,255,1.0)"){
                keyTitle = "Source";
            }else if(b == "rgb(255,186,117)"){
                keyTitle = "pH 6.0-6.9";
            }else if(b == "rgb(255,140,117)"){
                keyTitle = "pH 8.0-8.9";
            }else if(b == "rgb(255,209,117)"){
                keyTitle = "pH 5.0-5.9";
            }else if(b == "rgb(255,232,117)"){
                keyTitle = "pH <5";
            }
            a.push('<div style="line-height:20px"><a href="#' + b + '"><div style="width:12px;height:12px;border-radius:10px;margin-right:5px;background:' + b + ';display:inline-block"></div>' + keyTitle + '</a></div>');
        }
    //a.sort();
...
function Search(a) {
    ...
    this.search = function (a) {
        ...
        this.lastSearch = a;
        this.results.empty();
        if (0 >= a.length) this.results.html("<i>Please enter something to search.</i>");
        else {
...
function Cluster(a) {
    this.cluster = a;
    this.display = !1;
    this.list = this.cluster.find(".select");
    this.list.empty();
...
function showCluster(a) {
    ...
    if (b && 0 < b.length) {
        ...
        sigInst.draw(2, 2, 2, 2);
            ...
            if (a == "rgb(163,255,161)"){
                $GP.info_name.html("<b>Branding</b>");
                $(".name b").css('color', 'rgb(163,255,161)');
            }else if(a == "rgba(41,197,210,0.8)"){
                $GP.info_name.html("<b>Country</b>");
                $(".name b").css('color', 'rgba(41,197,210,0.8)');
            }else if(a == "rgba(50,80,252,0.8)"){
                $GP.info_name.html("<b>Brand Name</b>");
                $(".name b").css('color', 'rgba(50,80,252,0.8)');
            }else if(a == "rgb(255,117,117)"){
                $GP.info_name.html("<b>pH >9</b>");
                $(".name b").css('color', 'rgb(255,117,117)');
            }else if(a == "rgb(255,163,117)"){
                $GP.info_name.html("<b>pH 7.0-7.9</b>");
                $(".name b").css('color', 'rgb(255,163,117)');
            }else if(a == "rgba(194,162,255,1.0)"){
                $GP.info_name.html("<b>Source</b>");
                $(".name b").css('color', 'rgba(194,162,255,1.0)');
            }else if(a == "rgb(255,186,117)"){
                $GP.info_name.html("<b>pH 6.0-6.9</b>");
                $(".name b").css('color', 'rgb(255,186,117)');
            }else if(a == "rgb(255,140,117)"){
                $GP.info_name.html("<b>pH 8.0-8.9</b>");
                $(".name b").css('color', 'rgb(255,140,117)');
            }else if(a == "rgb(255,209,117)"){
                $GP.info_name.html("<b>pH 5.0-5.9</b>");
                $(".name b").css('color', 'rgb(255,209,117)');
            }else if(a == "rgb(255,232,117)"){
                $GP.info_name.html("<b>pH <5</b>");
                $(".name b").css('color', 'rgb(255,232,117)');
            }else{
                $(".name").css('color', '#ccc');
            }
